...
export default function PaymentForm({ initState }: any) {
  ...
  const handleAmountChange = (event: { target: { value: string } }) => {
    ...
    initState.handleAmountChange(event);
  };
  ...
  const handlePaymentTypeChange = (event: {
    ...
    initState.handlePaymentTypeChange(event);
  };

  const handleCardHolderChange = (event: { target: { value: string } }) => {
    setCardHolder(event.target.value);
    initState.handleCardHolderChange(event);
  };
  ...
  const handleCardNumberChange = (event: { target: { value: string } }) => {
    ...
    initState.handleCardNumberChange(event);
  };
  ...
  const handleCvvChange = (event: { target: { value: string } }) => {
    ...
    initState.handleCvvChange(event);
  };
  ...
  const handleExpirationDateChange = (event: { target: { value: string } }) => {
    ...
    initState.handleExpirationDateChange(event);
  };
